...
export function AuthSignIn() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-primary to-[#ff5757] p-4">
      <Card className="w-full max-w-sm text-center">
        <CardHeader>
          ...
          <CardDescription>
            Inicia sesión para acceder a tu ecosistema.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            >
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24">
                ...
                <path
                  fill="currentColor"
                  d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.3v2.84C4.02 20.94 7.7 23 12 23z"
                />
                <path
                  fill="currentColor"
                  d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.3C1.42 8.84 1 10.4 1 12s.42 3.16 1.2 4.93l3.54-2.84z"
                />
                <path
                  fill="currentColor"
                  d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 4.02 3.06 2.3 5.93l3.54 2.84c.87-2.6 3.3-4.53 6.16-4.53z"
                />
              </svg>
